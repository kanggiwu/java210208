...
////////////메뉴바 추가하기 ///////////////
	//컴파일 타임에 인스턴스화 하기 - 이른 인스턴스화이다.(멀티스레드에서 안전하지 못하다.- 메모리 과다 사용==>싱글톤으로 가야한다.)
	//파라미터를 갖는 생성자가 하나라도 있으면 어떠한 생성자도 제공하지 않는다.
		BaseballGameEvent bbgEvent = new BaseballGameEvent(this);
		BaseballGameLogic bbgLogic = new BaseballGameLogic(this);
		//BaseballGameEvent bbgEvent = new BaseballGameEvent(this,bbgLogic);//logic과 view를 같이 넘긴다.
